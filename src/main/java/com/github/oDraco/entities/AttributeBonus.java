...
public class AttributeBonus {
    ...
    public AttributeBonus(DBCAttribute attribute, String name, String value) {
        if (!VALUE_REGEX.matcher(value).matches())
            throw new IllegalArgumentException(value + " is a invalid value. Examples of valid values: +1, -1, *1, /1, *nbt_jrmcAlign");
    ...
    public static AttributeBonus fromString(DBCAttribute attr, String input) {
        ...
        if (fields.length != 2)
            throw new IllegalArgumentException(input + " is a invalid format. Example format: bonus;*2");
